                    ...
                    <div className="bp-detail">
                        <div className="bp-detail__thumbnail">
                            ...
                            <div className="aspect aspect--bg-grey aspect--1366-768">
                                ...
                                <img className="aspect__img" src="images/blog/post-12.jpg" alt=""/></div>
                            {/*====== End - Image Code ======*/}
                        </div>
                        <div className="bp-detail__info-wrap">
                            ...
                            <p className="bp-detail__p">Lorem Ipsum is simply dummy text of the <em>printing</em> and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown
